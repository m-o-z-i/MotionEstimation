...
bool getRightProjectionMat(cv::Mat& E, const cv::Mat K, const cv::Mat KInv, const cv::Mat distCoeff, vector<cv::Point2f>& inliersF1, vector<cv::Point2f>& inliersF2, cv::Mat& P1, std::vector<cv::Point3f>& outCloud);

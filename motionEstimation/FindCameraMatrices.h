...
bool getRightProjectionMat(cv::Mat& E, const cv::Mat K, const cv::Mat KInv, const cv::Mat distCoeff, cv::Mat& P1, const vector<cv::Point2f>& inliersF1, const vector<cv::Point2f>& inliersF2, std::vector<cv::Point3f>& outCloud);
